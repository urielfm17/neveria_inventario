...
<div class="contenedor">
    ...
    <!-- FILTROS Y BUSCADOR -->
    <div class="buscador">
        <input type="text" id="inputBuscar" placeholder="Buscar por sabor..." oninput="cargarExistencias()">
        <div class="filtros-tipo">
            <button class="btn-filtro activo" data-tipo="" onclick="seleccionarFiltro(this)">Todos</button>
        ...
        <div class="filtros-nivel">
            ...
            <button class="btn-nivel activo" data-nivel="" onclick="seleccionarNivel(this)">Todos</button>
            <button class="btn-nivel" data-nivel="5" onclick="seleccionarNivel(this)">★★★★★</button>
            <button class="btn-nivel" data-nivel="4" onclick="seleccionarNivel(this)">★★★★☆</button>
            <button class="btn-nivel" data-nivel="3" onclick="seleccionarNivel(this)">★★★☆☆</button>
            <button class="btn-nivel" data-nivel="2" onclick="seleccionarNivel(this)">★★☆☆☆</button>
            <button class="btn-nivel" data-nivel="1" onclick="seleccionarNivel(this)">★☆☆☆☆</button>
        </div>
    </div>
    ...
    <div class="tabla-contenedor">
        ...
        <table>
            ...
            <tbody id="tablaExistencias">
                <tr><td colspan="7" class="cargando"><i class="bi bi-hourglass-split"></i> Cargando...</td></tr>
            </tbody>
        </table>
